...
def main(args):
    ...
    if args.joined_dictionary:
        ...
        if args.srcdict:
            ...
            src_dict1 = build_dictionary([train_path(args.source_lang1)], args.workers)
            src_dict2 = build_dictionary([train_path(args.source_lang2)], args.workers)
        if target:
            if args.tgtdict:
    ...
    src_dict1.save(dict_path(args.source_lang1))
    src_dict2.save(dict_path(args.source_lang2))
    if target:
    ...
    make_all(args.source_lang1)
    make_all(args.source_lang2)
    if target:
